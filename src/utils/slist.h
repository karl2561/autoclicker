...
/* Takes the head of an slist, prepends data at the start,returns the new head
 */
...
/* Takes the tail of an slist and appends data at the tail, returns the new tail
 */
